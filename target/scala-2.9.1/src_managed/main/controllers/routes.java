...
public class routes {
public static final controllers.ReverseTaskController TaskController = new controllers.ReverseTaskController();
...
public static final controllers.javascript.ReverseTaskController TaskController = new controllers.javascript.ReverseTaskController();
...
public static final controllers.ref.ReverseTaskController TaskController = new controllers.ref.ReverseTaskController();
